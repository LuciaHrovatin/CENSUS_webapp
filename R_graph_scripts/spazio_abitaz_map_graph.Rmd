...
choropleth_ita_tot_GDP = ggplot() +
  ...
  labs(title="Spazio abitativo medio", 
       subtitle="Mq medi delle abitazioni/componenti medi per famiglia") +
  theme_void() +
  theme(
  ...
  guides(fill=guide_legend("Millions of EUR")) +
  coord_map() +
  scale_fill_distiller(guide = FALSE, direction = 1, limits=c(66.01,101.88))
